...
for batch_idx in range(156):  # Simulate a single batch
    ...
    for i in range(num_curves):
        ...
        control_points, intensity, thickness = torch.rand(batch_size, num_points, 2, device=device), torch.rand(batch_size, device=device), torch.rand(batch_size, device=device) * 3.0
